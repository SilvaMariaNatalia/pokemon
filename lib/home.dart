  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 244, 54, 203),
      ),
      ...
      itemBuilder: (context, index) {
        return Container(
          child: Container(
            ...
            color:  Color.fromARGB(255, 190, 94, 160),
                ...
                MaterialPageRoute<Widget>(builder: (BuildContext context) {
                  ...
                  borderRadius: BorderRadius.all(Radius.circular(25))),
                                  ...
                                  Container(
                                    ...
                                    color: Color.fromARGB(255, 216, 74, 190),
                                    border: Border.all(
